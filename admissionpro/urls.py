...
urlpatterns = [
    ...
    path('student-predictions',user_views.student,name="student"),
    path('otp-verification',user_views.otp,name="otp"),
    path('forgot-password',user_views.forgot_password,name="forgot"),
    ...
    path('XB-Boost',admin_views.alg1,name="alg1"),
    ...
    path('LinearRegression',admin_views.alg6,name="alg6"),
    path('svm',admin_views.alg7,name="alg7"),
